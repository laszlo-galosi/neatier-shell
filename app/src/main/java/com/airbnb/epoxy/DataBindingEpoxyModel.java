...
public abstract class DataBindingEpoxyModel
    ...
    View buildView(ViewGroup parent) {
        ...
        ViewDataBinding binding =
              DataBindingUtil.inflate(layoutInflater, getViewType(), parent, false);
     ...
     * with the model's data. {@link ViewDataBinding#executePendingBindings()} is called for you
     * after
     * this method is run.
     * <p>
     * If you leave your class abstract and have a model generated for you via annotations this
     * will
